        ...
        protected override void Update()
        {
            ...
            if (serialPort.IsOpen)
            {
                try
                {
                    ...
                    if (value == 00000001) //Comparamos con el valor ASCII del '1'
                        direction = 1;
                    else if (value == 00000010)
                        direction = 2;
                    else
                        direction = 0;
                }
...
*/
        ...
        void MoveVehicle(bool accelerate, bool brake, float turnInput)
        {
            ...
            //float accelInput = Convert.ToSingle(moveFront);
            float accelInput = (moveFront ? 1.0f : 0.0f) - (brake ? 1.0f : 0.0f);
